...
import { CarouselImageModal } from "@/components/admin/CarouselImageModal";
                  ...
                  <div className="p-4">
                    ...
                    {image.link_url && (
                      <a
                        ...
                        className="text-xs text-primary-600 hover:underline block mb-3 truncate"
                      >
                        {image.link_url}
                      </a>
                    )}
                    ...
                    <div className="flex gap-2 mt-4">
                      ...
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1 bg-red-100 hover:bg-red-200 text-red-700 px-3 py-2 rounded text-sm font-medium transition-colors"
                        title="Delete"
                      >
